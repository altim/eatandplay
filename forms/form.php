<?php       
	...
	<style>
		...
		.inputError {
			border-color: #E96682 !important;
			box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.075) inset, 0px 0px 8px rgba(233, 102, 102, 0.6) !important;
		}
		
		#cardform .container-fluid {
			display:block;
			margin:auto;
			padding:20px;
		...
		#step2 .row .col-md-4 .deliveryOptionH4 { 
...
<div id="cardform">
	<div class="container-fluid">
		...
		if($_GET['comp'] != "")
		{   
			echo "<div style='background-color: #33B64B; display: block;'><h1>Purchase Confirmed</h1></div>";
		}
		?>
		<form>
			...
			<div id="step1">
				...
				<div class="insider">
					...
					<div class="row" style="margin-top:-20px;">
						...
						<div class="col-md-6">
							<h4>Quantity ($25 USD per card)</h4>
					...
					<button type="button" id="btn1" class="btn btn-primary" style="float:right; margin-top:20px;">Confirm</button>
			...
			<div id="step2">
				...
				<div class="insider" style="margin-top:-20px;">
					...
					<h3>Customer Information</h3><span style="color: red; font-size: 10px;">* all fields are required!</span>
					<div class="row">
						<div class="col-md-4">
					...
					<div class="row">
						<div class="col-md-4">
							<select class="form-control" name="country" id="country-selector">
						...
						<div class="col-md-4">
							<input class="form-control" type="text" name="state" id="state-province-text" placeholder="State / Province" />
							
							 <select class="form-control" name="stateCanada" id="canada-selector">
							...
							<select class="form-control" name="stateUS" id="usa-selector">
						...
						<div class="col-md-4">
							<input class="form-control" type="text" name="zip" placeholder="ZIP/Postal Code" />
						</div>
					</div>
						
					<div class="row">
						<div class="col-md-4">
							<input class="form-control" type="text" name="phone" placeholder="Daytime Phone" />
						</div>
						<div class="col-md-4">
							<input class="form-control" type="text" name="email" placeholder="Email" />
						</div>
						<div class="col-md-4">
							<input class="form-control" type="text" name="verifyemail" placeholder="Verify Email" />
						</div>
					</div>	
					...
					<div class="row">
						<div class="col-md-4">
							...
							<select class="form-control" name="sendcardby" id="sendcardby">
								<option value="Email">I'll print it from the email voucher</option>	
								<option value="Post">Send card by post <strong>(FREE)</strong></option>
															
							</select>
						</div>	
							<div class="col-md-4">
							<h4 class="deliveryOptionH4">Send card by post</h4>
							<p>
							<strong>Please allow the following time for shipping and handling</strong><br/>
							US/Canada - 2 weeks<br/>
							UK - 3 weeks<br/>
							Rest of World - 4 weeks
							</p>
							</div>	
					
							<div class="col-md-4">
							<h4 class="deliveryOptionH4">Email me a voucher</h4>							
							<p><strong>You will immediately receive a voucher by email</strong><br/>
							Print voucher and exchange for your card at:<br/>
							3 convenient locations in <span class="thisToolTip" title="7324 International Drive
15657 State Road 535, Lake Buena Vista Factory Stores<br/>
8285 Champions Gate Blvd., Davenport">Orlando</span> <br/>
							4 convenient locations in <span class="thisToolTip" title="777 8th Avenue
234 W. 42nd Street
Grand Central Station
Port Authority"  >New York</span> <br>Complete address, phone and hours of operation will be on your voucher
							</p> 
							</div>	
					...
					<div class="row">
						...
						<div class="col-md-4">
							<h4>Card Expiry Month</h4>
							<select class="form-control" name="cc-exp-month">
						...
						<div class="col-md-4">
							<h4>Card Expiry Year</h4>
							<select class="form-control" name="cc-exp-year">
								<?php
					...
					<div class="row">
						<div class="col-md-4">
							<input class="form-control" type="text" name="cc-name" placeholder="Name on Card" />
						</div>
						<div class="col-md-6">
							<input class="form-control" autocomplete="off" type="text" name="cc-number" placeholder="Credit Card Number" />
						</div>
						<div class="col-md-2">
							<input class="form-control" type="text" name="cc-code" placeholder="Security Code" /><a style="color:#000; padding-top:8px; float:right;" href="#" onclick="window.open('visa_cvv2.jpg',  'open_window', 'menubar=no,toolbar=no,location=no,directories=no,status=no,scrollbars=no,resizable=no,width=315,height=260,left=250,top=250');">what is it?</a>
						</div>
						
						

							<div class="col-md-4">
								<input class="form-control" type="text" name="promo-code" placeholder="Promo Code (Optional)" />
							</div>
					...
					<button type="button" id="btn2" style="float:right;" class="btn btn-primary">Confirm</button>
					<div style="clear:both;"></div>
				...
				<div class="insider">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="submit" id="submitButton" class="btn btn-success" value="Purchase" style="float:right" /><button type="button" id="btn3" style="float:right; margin-right:10px;font-size: 12px;" class="btn btn-warning">Modify information</button>
							
							
							<div style="clear:both;"></div>
							<br />
							<img src="../forms/ajax-loader.gif" width="16px" height="16px" id="loader-gif" style="float:right;" />
						</div>
					</div>
					
					<div class="row">
						<div class="col-md-12" style="font-size:12px; text-align:center; padding-top:20px;">Please check your email immediately to confirm purchase receipt.</div>
					
						<div class="col-md-12" style="font-size:12px; text-align:center; padding-top:20px;">By clicking on the purchase button, you will have confirmed your order and an email confirmation will be sent to you. Thank you for your order! Enjoy! </div>
					</div>
		...
		<div id="stepwork">
			...
			<div class="insider">
				Thank you for your Eat and Play Card order! Your order was processed successfully.<br />
				An order confirmation has been sent to your email address.
				
				<br /><br />
				<b>If you have not received the confirmation email in 5 minutes please verify your spam folder.</b>
			</div>
		...
		<div id="stepfail">
			...
			<div class="insider">
				...
				<button class="btn btn-warning" style="float:right; margin-right:10px;font-size: 12px;" id="btn3R" type="button">Modify information</button>
			</div>
				...
				if (verifyFieldNumbers("input[name=lastname]") == true)
				{
					...
					if (verifyFieldEmpty("input[name=address]") == true) {
						...
						if (verifyFieldEmpty("input[name=city]") == true) {
							...
							if ( !($("[name=country]").val() == "NONE") )
							{
								//State Verification
								if (verifyFieldEmpty("input[name=state]") == true || $("[name=country]").val() == "CA" || $("[name=country]").val() == "US" ) {
