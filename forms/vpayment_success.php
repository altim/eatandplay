...
<html>
<head>
<title>Thank You for Your Purchase - Eat and Play Card: Take a bite out of vacation expenses</title>
		  ...
		  <tr>
		   <td width="230px" valign="top" align="center"><!-- LEFT COLUMN -->
		      <span style="font-family:arial;font-size:4px;"><br /><br /></span>
                          <img src="images/buy_success.png" border="0" width="108" height="134" alt="Order Successful" />
					   <span style="font-family:arial;font-size:4px;"><br /><br /></span>
		   </td>
		   </td>
			   ...
			   <span style="font-family:arial-font-size:4px;"><br /></span>
				...
				?>
												<table border="0" cellpadding="0" cellspacing="3" width="550px">
													<tr>
													<td>Thank you for your Eat and Play Card order!  Your order was processed successfully.<br /> An order confirmation has been sent to your email address.<p><strong>If you have not received the confirmation email in 5 minutes please verify your spam folder.</strong></p></td>
													<iframe src="https://t.pepperjamnetwork.com/track?PID=4564&AMOUNT=0.00&TYPE=2&OID=<?php echo $order_id;?>&CURRENCY=USD" height="1" width="1" frameborder="0"></iframe>
													</tr>
												</table>
